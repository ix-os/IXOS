...
example.sqfs:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/etc/calamares/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating example.sqfs"
	/usr/bin/mksquashfs /etc/calamares/data/example-root/ /etc/calamares/example.sqfs -all-root
	/usr/bin/mksquashfs /sbin /bin /lib /lib64 /etc/calamares/example.sqfs -all-root
...
CMakeFiles/example-distro.dir/depend:
	cd /etc/calamares && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /etc/calamares /etc/calamares /etc/calamares /etc/calamares /etc/calamares/CMakeFiles/example-distro.dir/DependInfo.cmake --color=$(COLOR)
